...
import { LayoutDashboard, FileText, Target, LogOut, BarChart3 } from 'lucide-react';

interface SidebarProps {
  activeTab: 'applications' | 'resume' | 'match' | 'analytics';
  onTabChange: (tab: 'applications' | 'resume' | 'match' | 'analytics') => void;
  onLogout: () => void;
}
